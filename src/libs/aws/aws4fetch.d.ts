...
export const HOST_SERVICES: {
    ...
    pinpoint: string;
    queue: string;
    'git-codecommit': string;
    'mturk-requester-sandbox': string;
    'personalize-runtime': string;
}
export const UNSIGNABLE_HEADERS: string[]
export const hmac: (key: any, string: any) => Promise<ArrayBuffer>
export const hash: (content: any) => Promise<ArrayBuffer>
export const buf2hex: (buffer: any) => any
export const encodeRfc3986: (urlEncodedStr: any) => any
export const guessServiceRegion: (url: any, headers: any) => any[]